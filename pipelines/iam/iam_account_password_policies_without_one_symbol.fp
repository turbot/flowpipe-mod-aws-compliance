locals {
  ...
  iam_account_password_policies_without_one_symbol_default_action_enum  = ["notify", "skip", "update_password_policy_require_symbols"]
  iam_account_password_policies_without_one_symbol_enabled_actions_enum = ["skip", "update_password_policy_require_symbols"]
}
...
variable "iam_account_password_policies_without_one_symbol_default_action" {
  ...
  default     = "notify"
  enum        = ["notify", "skip", "update_password_policy_require_symbols"]
...
variable "iam_account_password_policies_without_one_symbol_enabled_actions" {
  ...
  enum        = ["skip", "update_password_policy_require_symbols"]
...
trigger "query" "detect_and_correct_iam_account_password_policies_without_one_symbol" {
  ...
  sql      = local.iam_account_password_policies_without_one_symbol_query
...
pipeline "detect_and_correct_iam_account_password_policies_without_one_symbol" {
  ...
  param "default_action" {
    ...
    default     = var.iam_account_password_policies_without_one_symbol_default_action
    enum        = local.iam_account_password_policies_without_one_symbol_default_action_enum
  }

  param "enabled_actions" {
    type        = list(string)
    description = local.description_enabled_actions
    default     = var.iam_account_password_policies_without_one_symbol_enabled_actions
    enum        = local.iam_account_password_policies_without_one_symbol_enabled_actions_enum
  }
