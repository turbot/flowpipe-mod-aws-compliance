      ...
      actions = {
        ...
        "enable_unauthorized_api_changes_metric_filter" = {
          ...
          pipeline_args = {
            cred             = param.cred
            region           = "us-east-1"
            log_group_name   = "log_group_name_30"
            filter_name      = "UnauthorizedAPIChangesMetric"
            role_name        = "UnauthorizedAPIChangesMetricrRole"
            trail_name       = "UnauthorizedAPIChangesMetricTrail"
            s3_bucket_name   = "unauthorizedapichangemetrics3bucket"
            metric_name      = "UnauthorizedAPIChangeMetrics"
            metric_namespace = "CISBenchmark"
            queue_name       = "flowpipeUnauthorizedAPIChanges"
            metric_value     = "1"
            ...
            sns_topic_name = "unauthorized_api_changes_metric_topic"
            protocol       = "SQS"
            alarm_name     = "unauthorized_api_changes_alarm"
            ...
            "Statement": [
              {
                ...
                "Resource": "arn:aws:s3:::UnauthorizedAPIchangemetrics3bucket"
              },
              {
                ...
                "Action": "s3:PutObject",
                "Resource": "arn:aws:s3:::UnauthorizedAPIchangemetrics3bucket/AWSLogs/533793682495/*",
                "Condition": {
                  "StringEquals": {
