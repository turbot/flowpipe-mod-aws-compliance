...
pipeline "correct_one_iam_user_with_unused_access_key_45_days" {
  title         = "Correct IAM user with unused access key from 45 days or more"
  description   = "Runs corrective action to deactivate IAM user access key that have been unused for 45 days or more."
