locals {
  cis_v300_2_control_mapping = {
    cis_v300_2_1 = {pipeline = pipeline.cis_v300_2_1}
...
variable "cis_v300_2_1_enabled_pipelines" {
  type        = list(string)
  description = "List of CIS v3.0.0 section 2.1 pipelines to enable."
  default     = [
    "cis_v300_2_1_1",
    /*
    "cis_v300_2_1_2",
...
pipeline "cis_v300_2_1" {
  ...
  step "pipeline" "run_pipelines" {
    ...
    pipeline = local.cis_v300_2_control_mapping[var.cis_v300_2_1_enabled_pipelines[loop.index]].pipeline
    args     = {
