pipeline "test_detect_and_correct_ec2_classic_load_balancers_without_connection_draining_enabled_enable_connection_draining" {
  ...
  step "query" "get_elb_classic_load_balancer" {
    ...
    sql = <<-EOQ
      ...
      where
        name = 'flowpipe-test'
        and connection_draining_enabled;
    EOQ
  }
