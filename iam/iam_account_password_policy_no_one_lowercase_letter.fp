...
pipeline "correct_one_iam_account_password_policy_no_one_lowercase_letter" {
  ...
  step "pipeline" "respond" {
    ...
    args = {
      ...
      notification_level = param.notification_level
      approvers          = param.approvers
      detect_msg         = "Detected IAM account password policy with no requirement for at least one lowercase letter ${param.title}."
      default_action     = param.default_action
      enabled_actions    = param.enabled_actions
      actions = {
        "skip" = {
          ...
          pipeline_args = {
            ...
            text     = "Skipped IAM account password policy ${param.title} with no requirement for at least one lowercase letter."
          }
          success_msg = ""
          error_msg   = ""
        },
        "update_password_policy_require_lowercase" = {
          ...
          success_msg = "Updated IAM account password policy ${param.title} to require at least one lowercase letter."
...
variable "iam_account_password_policy_no_one_lowercase_letter_default_action" {
  ...
  default     = "update_password_policy_require_lowercase"
}
