...
pipeline "correct_iam_user_with_policy_star_star_attached" {
  title         = "Correct IAM user attached with *:* policy"
  description   = "Runs corrective action to detach the *:* policy from IAM user."
