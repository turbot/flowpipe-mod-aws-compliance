...
pipeline "correct_accounts_without_metric_filter_for_route_table_changes" {
  ...
  step "message" "notify_detection_count" {
    ...
    notifier = param.notifier
    text     = "Detected ${length(param.items)} account(s) without metric filter for route table changes."
  }
  ...
  step "message" "notify_items" {
    ...
    notifier = param.notifier
    text     = "Detected account ${each.value.title} without metric filter for route table changes."
  }
}
