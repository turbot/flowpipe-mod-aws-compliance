...
trigger "query" "detect_and_correct_cloudwatch_log_groups_without_metric_filter_for_security_group_changes" {
  ...
  description = "Detect CloudWatch log groups that do not have a metric filter for security group changes and then enable security group changes metric filter."
...
pipeline "correct_cloudwatch_log_groups_without_metric_filter_for_security_group_changes" {
  ...
  description = "Enable security group changes metric filter for CloudWatch log groups without metric filter for security group changes."
  ...
  step "message" "notify_detection_count" {
    ...
    text     = "Detected CloudWatch log group(s) ${length(param.items)} without metric filter for security group changes."
  }
