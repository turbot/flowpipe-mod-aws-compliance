...
pipeline "correct_iam_role_with_unrestricted_cloudshell_full_access" {
  title         = "Correct IAM role with unrestricted CloudShellFullAccess policy"
  description   = "Runs corrective action to detach the unrestricted CloudShellFullAccess policy from IAM role."
