...
trigger "query" "detect_and_correct_cloudwatch_log_groups_without_metric_filter_for_unauthorized_api_changes" {
  ...
  description = "Detect CloudWatch log groups without metric filter for unauthorized API changes and then enable unauthorized API changes metric filter."
...
pipeline "correct_cloudwatch_log_groups_without_metric_filter_for_unauthorized_api_changes" {
  ...
  description = "Enable unauthorized API changes metric filter for CloudWatch log groups without metric filter for unauthorized API changes."
  ...
  step "message" "notify_detection_count" {
    ...
    notifier = param.notifier
    text     = "Detected CloudWatch log group(s) ${length(param.items)} without metric filter for unauthorized API changes."
  }
...
pipeline "correct_one_cloudwatch_log_groups_without_metric_filter_for_unauthorized_api_changes" {
  ...
  description = "Enable unauthorized API changes metric filter for a CloudWatch log group."
  tags        = merge(local.cloudwatch_common_tags, { type = "internal" })
