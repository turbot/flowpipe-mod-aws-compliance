      ...
      actions = {
        ...
        "enable_bucket_policy_changes_metric_filter" = {
          ...
          pipeline_args = {
            cred             = param.cred
            region           = "us-east-1"
            log_group_name   = "log_group_name_39"
            filter_name      = "BucketPolicyChangesMetric"
            role_name        = "BucketPolicyChangesMetricRole"
            trail_name       = "BucketPolicyChangesMetricTrail"
            s3_bucket_name   = "bucketpolicychangemetrics3bucket"
            metric_name      = "BucketPolicyChangeMetrics"
            metric_namespace = "CISBenchmark"
            queue_name       = "flowpipeBucketPolicyChanges"
            metric_value     = "1"
            ...
            sns_topic_name = "bucket_policy_changes_metric_topic"
            protocol       = "SQS"
            alarm_name     = "bucket_policy_changes_alarm"
            ...
            "Statement": [
              {
                ...
                "Resource": "arn:aws:s3:::bucketpolicychangemetrics3bucket"
              },
              {
                ...
                "Action": "s3:PutObject",
                "Resource": "arn:aws:s3:::bucketpolicychangemetrics3bucket/AWSLogs/533793682495/*",
                "Condition": {
                  "StringEquals": {
