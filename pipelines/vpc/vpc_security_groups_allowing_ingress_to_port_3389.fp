locals {
  ...
  vpc_security_groups_allowing_ingress_to_port_3389_default_action_enum  = ["notify", "skip", "revoke_security_group_rule"]
  vpc_security_groups_allowing_ingress_to_port_3389_enabled_actions_enum = ["skip", "revoke_security_group_rule"]
}
...
pipeline "detect_and_correct_vpc_security_groups_allowing_ingress_to_port_3389" {
  ...
  param "default_action" {
    ...
    enum        = local.vpc_security_groups_allowing_ingress_to_port_3389_default_action_enum
  }
  ...
  param "enabled_actions" {
    ...
    enum        = local.vpc_security_groups_allowing_ingress_to_port_3389_enabled_actions_enum
  }
