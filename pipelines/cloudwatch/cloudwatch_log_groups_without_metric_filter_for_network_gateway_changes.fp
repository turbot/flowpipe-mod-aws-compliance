...
pipeline "correct_cloudwatch_log_groups_without_metric_filter_for_network_gateway_changes" {
  ...
  step "message" "notify_detection_count" {
    ...
    notifier = param.notifier
    text     = "Detected ${length(param.items)} account(s) without metric filter for network gateway changes."
  }
  ...
  step "message" "notify_items" {
    ...
    notifier = param.notifier
    text     = "Detected account ${each.value.title} without metric filter for network gateway changes."
  }
}