...
locals {
  ...
  aws_pipeline_enable_security_hub_without_default_standards = aws.pipeline.enable_security_hub_without_default_standards
  aws_pipeline_enable_security_hub_with_default_standards    = aws.pipeline.enable_security_hub_with_default_standards
}