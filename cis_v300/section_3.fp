locals {
  ...
  cis_v300_3_control_mapping = {
    cis_v300_3_1  = {pipeline = pipeline.detect_and_correct_cloudtrail_trails_with_multi_region_read_write_disabled, additional_args = {}}
    ...
    cis_v300_3_8  = {pipeline = pipeline.detect_and_correct_cloudtrail_trails_with_s3_object_level_logging_for_write_events_disabled, additional_args = {}}
    cis_v300_3_9  = {pipeline = pipeline.detect_and_correct_cloudtrail_trails_with_s3_object_level_logging_for_read_events_disabled, additional_args = {}}
  }
}
