locals {
  iam_roles_with_unrestricted_cloudshell_full_access_query = <<-EOQ
    select
  ...
  iam_roles_with_unrestricted_cloudshell_full_access_default_action_enum  = ["notify", "skip", "detach_role_cloudshell_full_access_policy"]
  iam_roles_with_unrestricted_cloudshell_full_access_enabled_actions_enum = ["skip", "detach_role_cloudshell_full_access_policy"]
}

variable "iam_roles_with_unrestricted_cloudshell_full_access_trigger_enabled" {
  type        = bool
...
variable "iam_roles_with_unrestricted_cloudshell_full_access_trigger_schedule" {
  type        = string
...
variable "iam_roles_with_unrestricted_cloudshell_full_access_default_action" {
  type        = string
  description = "The default action to use when there are no approvers."
  default     = "notify"
  enum        = ["notify", "skip", "detach_role_cloudshell_full_access_policy"]
...
variable "iam_roles_with_unrestricted_cloudshell_full_access_enabled_actions" {
  type        = list(string)
  description = "The list of enabled actions approvers can select."
  default     = ["skip", "detach_role_cloudshell_full_access_policy"]
  enum        = ["skip", "detach_role_cloudshell_full_access_policy"]
...
trigger "query" "detect_and_correct_iam_roles_with_unrestricted_cloudshell_full_access" {
  ...
  sql      = local.iam_roles_with_unrestricted_cloudshell_full_access_query

  capture "insert" {
    pipeline = pipeline.correct_iam_roles_with_unrestricted_cloudshell_full_access
    args = {
...
pipeline "detect_and_correct_iam_roles_with_unrestricted_cloudshell_full_access" {
  ...
  param "default_action" {
    ...
    default     = var.iam_roles_with_unrestricted_cloudshell_full_access_default_action
    enum        = local.iam_roles_with_unrestricted_cloudshell_full_access_default_action_enum
  }

  param "enabled_actions" {
    type        = list(string)
    description = local.description_enabled_actions
    default     = var.iam_roles_with_unrestricted_cloudshell_full_access_enabled_actions
    enum        = local.iam_roles_with_unrestricted_cloudshell_full_access_enabled_actions_enum
  }
...
pipeline "correct_iam_roles_with_unrestricted_cloudshell_full_access" {
  ...
  step "message" "notify_detection_count" {
    ...
    notifier = param.notifier
    text     = "Detected ${length(param.items)} IAM role(s) with unrestricted CloudShellFullAccess policy attached."
  }
...
pipeline "correct_one_iam_role_with_unrestricted_cloudshell_full_access" {
  ...
  step "pipeline" "respond" {
    ...
    args = {
      ...
      notification_level = param.notification_level
      approvers          = param.approvers
      detect_msg         = "Detected IAM role ${param.title} atttached with the policy `arn:aws:iam::aws:policy/AWSCloudShellFullAccess`."
      default_action     = param.default_action
      enabled_actions    = param.enabled_actions
      actions = {
        "skip" = {
          ...
          pipeline_args = {
            ...
            text     = "Skipped IAM role ${param.title}."
          }
          success_msg = ""
          error_msg   = ""
        },
