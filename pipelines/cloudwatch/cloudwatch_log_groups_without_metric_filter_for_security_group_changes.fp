locals {
  cloudwatch_log_groups_without_metric_filter_for_security_group_changes_query = <<-EOQ
    with filter_data as (
      select
        trail.account_id,
...
variable "cloudwatch_log_groups_without_metric_filter_for_security_group_changes_trigger_enabled" {
  type        = bool
  default     = false
  description = "If true, the trigger is enabled."
}

variable "cloudwatch_log_groups_without_metric_filter_for_security_group_changes_trigger_schedule" {
  type        = string
  default     = "15m"
  description = "If the trigger is enabled, run it on this schedule."
}

variable "cloudwatch_log_groups_without_metric_filter_for_security_group_changes_default_action" {
  type        = string
  description = "The default action to use when there are no approvers."
  default     = "notify"
}

variable "cloudwatch_log_groups_without_metric_filter_for_security_group_changes_default_actions" {
  type        = list(string)
  description = " The list of enabled actions approvers can select."
  default     = ["skip", "enable_security_group_changes_metric_filter"]
}

variable "loudwatch_log_groups_without_metric_filter_for_security_group_changes_log_group_name" {
  type        = string
  description = "The name of the log group to create."
  default     = "log_group_name_37"
}

variable "loudwatch_log_groups_without_metric_filter_for_security_group_changes_region" {
  type        = string
  description = "The region to create the log group in."
  default     = "us-east-1"
}

variable "loudwatch_log_groups_without_metric_filter_for_security_group_changes_filter_name" {
  type        = string
  description = "The name of the metric filter."
  default     = "SecurityGroupChangesMetric"
}

variable "loudwatch_log_groups_without_metric_filter_for_security_group_changes_role_name" {
  type        = string
  description = "The name of the IAM role to create."
  default     = "SecurityGroupChangesMetricRole"
}

variable "loudwatch_log_groups_without_metric_filter_for_security_group_changes_s3_bucket_name" {
  type        = string
...
variable "loudwatch_log_groups_without_metric_filter_for_security_group_changes_metric_name" {
  type        = string
  description = "The name of the metric."
  default     = "SecurityGroupChangeMetrics"
}

variable "loudwatch_log_groups_without_metric_filter_for_security_group_changes_metric_namespace" {
  type        = string
  description = "The namespace of the metric."
  default     = "CISBenchmark"
}

variable "loudwatch_log_groups_without_metric_filter_for_security_group_changes_queue_name" {
  type        = string
  description = "The name of the SQS queue."
  default     = "flowpipeSecurityGroupeChanges"
}

variable "loudwatch_log_groups_without_metric_filter_for_security_group_changes_metric_value" {
  type        = string
  description = "The value to publish to the metric."
  default     = "1"
}

variable "loudwatch_log_groups_without_metric_filter_for_security_group_changes_filter_pattern" {
  type        = string
...
variable "loudwatch_log_groups_without_metric_filter_for_security_group_changes_sns_topic_name" {
  type        = string
  description = "The name of the Amazon SNS topic to create."
  default     = "security_group_changes_metric_topic"
}

variable "loudwatch_log_groups_without_metric_filter_for_security_group_changes_alarm_name" {
  type        = string
  description = "The name of the CloudWatch alarm."
  default     = "security_group_changes_alarm"
}

variable "loudwatch_log_groups_without_metric_filter_for_security_group_changes_trail_name" {
  type        = string
  description = "The name of the CloudTrail trail."
  default     = "SecurityGroupChangesMetricTrail"
}

variable "loudwatch_log_groups_without_metric_filter_for_security_group_changes_protocol" {
  type        = string
  description = "The protocol to use for the subscription (e.g., email, sms, lambda, etc.)."
  default     = "SQS"
}

trigger "query" "detect_and_correct_cloudwatch_log_groups_without_metric_filter_for_security_group_changes" {
  title       = "Detect & correct CloudWatch log groups without metric filter for security group changes"
  ...
  // documentation = file("./cloudwatch/docs/detect_and_correct_cloudwatch_log_groups_without_metric_filter_for_security_group_changes_trigger.md")
  tags = merge(local.cloudwatch_common_tags, { class = "unused" })

  enabled  = var.cloudwatch_log_groups_without_metric_filter_for_security_group_changes_trigger_enabled
  schedule = var.cloudwatch_log_groups_without_metric_filter_for_security_group_changes_trigger_schedule
  database = var.database
  sql      = local.cloudwatch_log_groups_without_metric_filter_for_security_group_changes_query

  capture "insert" {
    pipeline = pipeline.correct_cloudwatch_log_groups_without_metric_filter_for_security_group_changes
    args = {
...
pipeline "detect_and_correct_cloudwatch_log_groups_without_metric_filter_for_security_group_changes" {
  title       = "Detect & correct CloudWatch log groups without metric filter for security group changes"
  description = "Detects CloudWatch log groups that do not have a metric filter for Security Group changes and runs your chosen action."
  // documentation = file("./cloudwatch/docs/detect_and_correct_cloudwatch_log_groups_without_metric_filter_for_security_group_changes.md")
  ...
  param "region" {
    ...
    default     = var.loudwatch_log_groups_without_metric_filter_for_security_group_changes_region
  }

  param "log_group_name" {
    type        = string
    description = "The name of the log group to create."
    default     = var.loudwatch_log_groups_without_metric_filter_for_security_group_changes_log_group_name
  }

  param "filter_name" {
    type        = string
    description = "The name of the metric filter."
    default     = var.loudwatch_log_groups_without_metric_filter_for_security_group_changes_filter_name
  }

  param "role_name" {
    type        = string
    description = "The name of the IAM role to create."
    default     = var.loudwatch_log_groups_without_metric_filter_for_security_group_changes_role_name
  }

  param "trail_name" {
    type        = string
    description = "The name of the CloudTrail trail."
    default     = var.loudwatch_log_groups_without_metric_filter_for_security_group_changes_trail_name
  }

  param "s3_bucket_name" {
    type        = string
    description = "The name of the S3 bucket to which CloudTrail logs will be delivered."
    default     = var.loudwatch_log_groups_without_metric_filter_for_security_group_changes_s3_bucket_name
  }

  param "metric_name" {
    type        = string
    description = "The name of the metric."
    default     = var.loudwatch_log_groups_without_metric_filter_for_security_group_changes_metric_name
  }

  param "metric_namespace" {
    type        = string
    description = "The namespace of the metric."
    default     = var.loudwatch_log_groups_without_metric_filter_for_security_group_changes_metric_namespace
  }

  param "metric_value" {
    type        = string
    description = "The value to publish to the metric."
    default     = var.loudwatch_log_groups_without_metric_filter_for_security_group_changes_metric_value
  }

  param "filter_pattern" {
    type        = string
    description = "The filter pattern for the metric filter."
    default     = var.loudwatch_log_groups_without_metric_filter_for_security_group_changes_filter_pattern
  }

  param "sns_topic_name" {
    type        = string
    description = "The name of the Amazon SNS topic to create."
    default     = var.loudwatch_log_groups_without_metric_filter_for_security_group_changes_sns_topic_name
  }

  param "queue_name" {
    type        = string
    description = "The name of the SQS queue."
    default     = var.loudwatch_log_groups_without_metric_filter_for_security_group_changes_queue_name
  }

  param "protocol" {
    type        = string
    description = "The protocol to use for the subscription (e.g., email, sms, lambda, etc.)."
    default     = var.loudwatch_log_groups_without_metric_filter_for_security_group_changes_protocol
  }

  param "alarm_name" {
    type        = string
    description = "The name of the CloudWatch alarm."
    default     = var.loudwatch_log_groups_without_metric_filter_for_security_group_changes_alarm_name
  }
  ...
  param "default_action" {
    ...
    default     = var.cloudwatch_log_groups_without_metric_filter_for_security_group_changes_default_action
  }

  param "enabled_actions" {
    type        = list(string)
    description = local.description_enabled_actions
    default     = var.cloudwatch_log_groups_without_metric_filter_for_security_group_changes_default_actions
  }
...
pipeline "correct_cloudwatch_log_groups_without_metric_filter_for_security_group_changes" {
  title       = "Correct CloudWatch log groups without metric filter for security group changes"
  ...
  // documentation = file("./cloudwatch/docs/correct_cloudwatch_log_groups_without_metric_filter_for_security_group_changes.md")
  tags = merge(local.cloudwatch_common_tags, { class = "unused" })
  ...
  step "message" "notify_detection_count" {
    ...
    text     = "Detected ${length(param.items)} CloudWatch log groups without metric filter for security group changes."
  }
  ...
  step "pipeline" "correct_item" {
    ...
    pipeline        = pipeline.correct_one_cloudwatch_log_groups_without_metric_filter_for_security_group_changes
    args = {
...
pipeline "correct_one_cloudwatch_log_groups_without_metric_filter_for_security_group_changes" {
  ...
  description = "Runs corrective action on a CloudWatch log group without metric filter for security group changes."
  // documentation = file("./cloudwatch/docs/correct_one_cloudwatch_log_groups_without_metric_filter_for_security_group_changes.md")
  tags = merge(local.cloudwatch_common_tags, { class = "unused" })
  ...
  step "pipeline" "respond" {
    ...
    args = {
      ...
      notification_level = param.notification_level
      approvers          = param.approvers
      detect_msg         = "Detected CloudWatch log group without metric filter for security group changes for account ${param.title}."
      default_action     = param.default_action
      enabled_actions    = param.enabled_actions
      actions = {
        "skip" = {
          ...
          pipeline_args = {
            ...
            text     = "Skipped CloudWatch log group without metric filter for security group changes for account ${param.title}."
          }
          success_msg = ""
          error_msg   = ""
        },
