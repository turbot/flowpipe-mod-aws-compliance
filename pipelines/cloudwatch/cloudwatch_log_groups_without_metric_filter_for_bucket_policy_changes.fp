...
trigger "query" "detect_and_correct_cloudwatch_log_groups_without_metric_filter_for_bucket_policy_changes" {
  ...
  description = "Detect CloudWatch log groups without metric filter for bucket policy changes and enable bucket policy changes metric filter."
...
pipeline "detect_and_correct_cloudwatch_log_groups_without_metric_filter_for_bucket_policy_changes" {
  title       = "Detect & correct CloudWatch log groups without metric filter for bucket policy changes"
  description = "Detects CloudWatch log groups without metric filter for Bucket Policy changes and enable bucket policy changes metric filter."
...
pipeline "correct_cloudwatch_log_groups_without_metric_filter_for_bucket_policy_changes" {
  ...
  description = "Enable bucket policy changes metric filter for CloudWatch log groups without metric filter for bucket policy changes."
  ...
  step "message" "notify_detection_count" {
    ...
    notifier = param.notifier
    text     = "Detected CloudWatch log group(s) ${length(param.items)} without metric filter for bucket policy changes."
  }
  ...
  step "pipeline" "respond" {
    ...
    args = {
      ...
      actions = {
        ...
        "enable_bucket_policy_changes_metric_filter" = {
          label        = "Enable bucket policy changes metric filter"
          value        = "enable_bucket_policy_changes_metric_filter"
          ...
          success_msg = "Enabled bucket policy changes metric filter for account ${param.title}."
          error_msg   = "Error enabling bucket policy changes metric filter for account ${param.title}."
        }
      }
    }
  }
...
pipeline "create_cloudwatch_metric_filter_bucket_policy_changes" {
