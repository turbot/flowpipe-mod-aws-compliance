...
variable "cloudwatch_log_groups_without_metric_filter_for_network_acl_changes_log_group_name" {
  type        = string
...
variable "cloudwatch_log_groups_without_metric_filter_for_network_acl_changes_region" {
  type        = string
...
variable "cloudwatch_log_groups_without_metric_filter_for_network_acl_changes_filter_name" {
  type        = string
...
variable "cloudwatch_log_groups_without_metric_filter_for_network_acl_changes_role_name" {
  type        = string
...
variable "cloudwatch_log_groups_without_metric_filter_for_network_acl_changes_s3_bucket_name" {
  type        = string
...
variable "cloudwatch_log_groups_without_metric_filter_for_network_acl_changes_metric_name" {
  type        = string
...
variable "cloudwatch_log_groups_without_metric_filter_for_network_acl_changes_metric_namespace" {
  type        = string
...
variable "cloudwatch_log_groups_without_metric_filter_for_network_acl_changes_queue_name" {
  type        = string
...
variable "cloudwatch_log_groups_without_metric_filter_for_network_acl_changes_metric_value" {
  type        = string
...
variable "cloudwatch_log_groups_without_metric_filter_for_network_acl_changes_filter_pattern" {
  type        = string
...
variable "cloudwatch_log_groups_without_metric_filter_for_network_acl_changes_sns_topic_name" {
  type        = string
...
variable "cloudwatch_log_groups_without_metric_filter_for_network_acl_changes_alarm_name" {
  type        = string
...
variable "cloudwatch_log_groups_without_metric_filter_for_network_acl_changes_trail_name" {
  type        = string
...
variable "cloudwatch_log_groups_without_metric_filter_for_network_acl_changes_protocol" {
  type        = string
...
trigger "query" "detect_and_correct_cloudwatch_log_groups_without_metric_filter_for_network_acl_changes" {
  ...
  description = "Detect CloudWatch log groups without metric filter for Network ACL changes and then enable network ACL changes metric filter."
...
pipeline "detect_and_correct_cloudwatch_log_groups_without_metric_filter_for_network_acl_changes" {
  ...
  param "region" {
    ...
    default     = var.cloudwatch_log_groups_without_metric_filter_for_network_acl_changes_region
  }

  param "log_group_name" {
    type        = string
    description = "The name of the log group to create."
    default     = var.cloudwatch_log_groups_without_metric_filter_for_network_acl_changes_log_group_name
  }

  param "filter_name" {
    type        = string
    description = "The name of the metric filter."
    default     = var.cloudwatch_log_groups_without_metric_filter_for_network_acl_changes_filter_name
  }

  param "role_name" {
    type        = string
    description = "The name of the IAM role to create."
    default     = var.cloudwatch_log_groups_without_metric_filter_for_network_acl_changes_role_name
  }

  param "trail_name" {
    type        = string
    description = "The name of the CloudTrail trail."
    default     = var.cloudwatch_log_groups_without_metric_filter_for_network_acl_changes_trail_name
  }

  param "s3_bucket_name" {
    type        = string
    description = "The name of the S3 bucket to which CloudTrail logs will be delivered."
    default     = var.cloudwatch_log_groups_without_metric_filter_for_network_acl_changes_s3_bucket_name
  }

  param "metric_name" {
    type        = string
    description = "The name of the metric."
    default     = var.cloudwatch_log_groups_without_metric_filter_for_network_acl_changes_metric_name
  }

  param "metric_namespace" {
    type        = string
    description = "The namespace of the metric."
    default     = var.cloudwatch_log_groups_without_metric_filter_for_network_acl_changes_metric_namespace
  }

  param "metric_value" {
    type        = string
    description = "The value to publish to the metric."
    default     = var.cloudwatch_log_groups_without_metric_filter_for_network_acl_changes_metric_value
  }

  param "filter_pattern" {
    type        = string
    description = "The filter pattern for the metric filter."
    default     = var.cloudwatch_log_groups_without_metric_filter_for_network_acl_changes_filter_pattern
  }

  param "sns_topic_name" {
    type        = string
    description = "The name of the Amazon SNS topic to create."
    default     = var.cloudwatch_log_groups_without_metric_filter_for_network_acl_changes_sns_topic_name
  }

  param "queue_name" {
    type        = string
    description = "The name of the SQS queue."
    default     = var.cloudwatch_log_groups_without_metric_filter_for_network_acl_changes_queue_name
  }

  param "protocol" {
    type        = string
    description = "The protocol to use for the subscription (e.g., email, sms, lambda, etc.)."
    default     = var.cloudwatch_log_groups_without_metric_filter_for_network_acl_changes_protocol
  }

  param "alarm_name" {
    type        = string
    description = "The name of the CloudWatch alarm."
    default     = var.cloudwatch_log_groups_without_metric_filter_for_network_acl_changes_alarm_name
  }
...
pipeline "correct_cloudwatch_log_groups_without_metric_filter_for_network_acl_changes" {
  ...
  description = "Enable network ACL changes metric filter for CloudWatch log groups wihtout metric filter for Network ACL changes."
  ...
  step "message" "notify_detection_count" {
    ...
    text     = "Detected CloudWatch log group(s) ${length(param.items)} without metric filter for network ACL changes."
  }
...
pipeline "correct_one_cloudwatch_log_groups_without_metric_filter_for_network_acl_changes" {
  ...
  description = "Enable network ACL changes metric filter for a CloudWatch log group."
