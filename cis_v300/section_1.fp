...
//   pipeline         = pipeline.iam_root_user_no_access_keys
...
//   pipeline         = pipeline.iam_root_user_mfa_enabled
...
//   pipeline         = pipeline.iam_root_user_hardware_mfa_enabled
...
//   pipeline         = pipeline.iam_root_last_used
...
//   pipeline         = pipeline.iam_account_password_policy_min_length_14
...
//   pipeline         = pipeline.iam_account_password_policy_reuse_24
...
//   pipeline         = pipeline.iam_user_console_access_mfa_enabled
...
//   pipeline         = pipeline.iam_user_access_keys_and_password_at_setup
...
//   pipeline         = pipeline.iam_user_unused_credentials_45
...
//   pipeline         = pipeline.iam_user_one_active_key
...
//   pipeline         = pipeline.iam_user_access_key_age_90
...
//   pipeline         = pipeline.iam_user_no_inline_attached_policies
...
//   pipeline         = pipeline.iam_policy_all_attached_no_star_star
...
//   pipeline         = pipeline.iam_support_role
...
//   pipeline         = pipeline.iam_server_certificate_not_expired
...
//   pipeline         = pipeline.iam_access_analyzer_enabled
...
//   pipeline         = pipeline.iam_user_group_role_cloudshell_fullaccess_restricted
